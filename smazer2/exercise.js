...
exercise.five = function(obj){
    ...
    // ----------------------------------------
    return (obj.first_name).concat(' '+obj.last_name);
};
...
exercise.eight = function(str){// FIX THIS ONE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    // ----------------------------------------
    //   QUESTION 08
   ...
   return numbers.reduce(function (a, b) {return Number(a) + Number(b);}, 0);
};
