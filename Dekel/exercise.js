...
exercise.three = function (str) {
    ...
    //var string = str.split(""); // ['a', 'p', 'p']
    //for (var i = 0; i < str.length; i++) {
    //    string = str.splice(0, 1);
    //    string += '_';
    //};
...
exercise.five = function (obj) {
    ...
    return obj.first_name + ' ' + obj.last_name; //solution1
...
exercise.six = function (arr) {
    ...
    // return arr.filter//not finished
};
...
exercise.eight = function (str) {
    ...
    // solution 1
    var val = 0;
    for (var i = 0; i < newStr.length; i++) { val += Number(newStr[i]); };
    return val;

    //solution 2
    //return newStr.reduce(function (prev, cur) { return Number(prev) + Number(cur) });
    //console.log(test);
